...
/**
 * @brief Transform a Pose (xs, ys, thetas) from source coordinate system (s) to target coordinate
 * system (t). The source coordinate system's origin (xst, yst, thetast) is represented in the
 * target coordinate system.
 *
 * @param xs, ys, thetas Pose (position and orientation) in the source coordinate system (s), with
 * theta in radians.
 * @param xst, yst, thetast Position and orientation of the source coordinate system's origin in the
 * target coordinate system (t), with theta in radians.
 * @param xt, yt, thetat Output the Pose (position and orientation) in the target coordinate system
 * (t), with theta in radians.
 */

inline void transCoord(const double &xs, const double &ys, const double &thetas, const double &xst,
                       const double &yst, const double &thetast, double &xt, double &yt,
                       double &thetat) {
