...
/**
 * The BrainCommunication class, which contains the operations related to communication each other
 * and to GameController. It make use of UDP broadcast to communicate with GameController. It also
 * make use of UDP broadcast to discover teammates and unicast to communicate with teammates.
 */
